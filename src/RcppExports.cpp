...
// coreDualLoopZ
void coreDualLoopZ(const MapMat cp_X, const MapMat cp_Y_X, const double n, const double sig2_zeta_vb, const double t02_inv, const double n0, MapMat Z, MapArr1D theta_vb, MapArr2D gam_vb, MapArr1D zeta_vb, MapMat m2_beta, const double sig2_inv_vb, const MapArr2D theta_plus_zeta_vb, const MapArr2D log_Phi_theta_plus_zeta, const MapArr2D log_1_min_Phi_theta_plus_zeta, const double log_sig2_inv_vb, const MapArr1D log_tau_vb, MapMat m1_beta, MapMat cp_betaX_X, MapArr2D mu_beta_vb, MapArr1D sig2_beta_vb, const MapArr1D tau_vb, const Eigen::VectorXi shuffled_ind, const Eigen::VectorXi sample_q, const double c);
RcppExport SEXP _atlasqtl_coreDualLoopZ(SEXP cp_XSEXP, SEXP cp_Y_XSEXP, SEXP nSEXP, SEXP sig2_zeta_vbSEXP, SEXP t02_invSEXP, SEXP n0SEXP, SEXP ZSEXP, SEXP theta_vbSEXP, SEXP gam_vbSEXP, SEXP zeta_vbSEXP, SEXP m2_betaSEXP, SEXP sig2_inv_vbSEXP, SEXP theta_plus_zeta_vbSEXP, SEXP log_Phi_theta_plus_zetaSEXP, SEXP log_1_min_Phi_theta_plus_zetaSEXP, SEXP log_sig2_inv_vbSEXP, SEXP log_tau_vbSEXP, SEXP m1_betaSEXP, SEXP cp_betaX_XSEXP, SEXP mu_beta_vbSEXP, SEXP sig2_beta_vbSEXP, SEXP tau_vbSEXP, SEXP shuffled_indSEXP, SEXP sample_qSEXP, SEXP cSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const MapMat >::type cp_X(cp_XSEXP);
    Rcpp::traits::input_parameter< const MapMat >::type cp_Y_X(cp_Y_XSEXP);
    Rcpp::traits::input_parameter< const double >::type n(nSEXP);
    Rcpp::traits::input_parameter< const double >::type sig2_zeta_vb(sig2_zeta_vbSEXP);
    Rcpp::traits::input_parameter< const double >::type t02_inv(t02_invSEXP);
    Rcpp::traits::input_parameter< const double >::type n0(n0SEXP);
    Rcpp::traits::input_parameter< MapMat >::type Z(ZSEXP);
    Rcpp::traits::input_parameter< MapArr1D >::type theta_vb(theta_vbSEXP);
    Rcpp::traits::input_parameter< MapArr2D >::type gam_vb(gam_vbSEXP);
    Rcpp::traits::input_parameter< MapArr1D >::type zeta_vb(zeta_vbSEXP);
    Rcpp::traits::input_parameter< MapMat >::type m2_beta(m2_betaSEXP);
    Rcpp::traits::input_parameter< const double >::type sig2_inv_vb(sig2_inv_vbSEXP);
    ...
    Rcpp::traits::input_parameter< MapMat >::type cp_betaX_X(cp_betaX_XSEXP);
    Rcpp::traits::input_parameter< MapArr2D >::type mu_beta_vb(mu_beta_vbSEXP);
    Rcpp::traits::input_parameter< MapArr1D >::type sig2_beta_vb(sig2_beta_vbSEXP);
    Rcpp::traits::input_parameter< const MapArr1D >::type tau_vb(tau_vbSEXP);
    Rcpp::traits::input_parameter< const Eigen::VectorXi >::type shuffled_ind(shuffled_indSEXP);
    Rcpp::traits::input_parameter< const Eigen::VectorXi >::type sample_q(sample_qSEXP);
    Rcpp::traits::input_parameter< const double >::type c(cSEXP);
    coreDualLoopZ(cp_X, cp_Y_X, n, sig2_zeta_vb, t02_inv, n0, Z, theta_vb, gam_vb, zeta_vb, m2_beta, sig2_inv_vb, theta_plus_zeta_vb, log_Phi_theta_plus_zeta, log_1_min_Phi_theta_plus_zeta, log_sig2_inv_vb, log_tau_vb, m1_beta, cp_betaX_X, mu_beta_vb, sig2_beta_vb, tau_vb, shuffled_ind, sample_q, c);
    return R_NilValue;
END_RCPP
}
// coreDualMisLoop
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_atlasqtl_coreDualLoopZ", (DL_FUNC) &_atlasqtl_coreDualLoopZ, 25},
